...
/**
 * Single simulation runner for Dynamic Grid Trading algorithm.
 *
 * Runs a single backtest with default or custom DynamicGrid configuration.
 *
 * Usage:
 *   java -cp bot-backtest/target/bot-backtest.jar \
 *     com.tradingbot.backtest.runners.DynamicGridSingleRunner [candle-file]
 *
 * Examples:
 *   DynamicGridSingleRunner
 *     → Uses default BTCUSDT-1-365.txt
 *
 *   DynamicGridSingleRunner ETHUSDT-1-365.txt
 *     → Uses custom file
 */
@Slf4j
public class DynamicGridSingleRunner {
    ...
    private static void runSingleSimulation(String candleFileName) throws Exception {
        log.info("Starting Dynamic Grid single simulation");
        ...
        DynamicGridConfig config = DynamicGridConfig.defaultConfig();
        ...
        System.out.println();
        System.out.println("========================================");
        System.out.println("  DYNAMIC GRID SIMULATION RESULTS");
        System.out.println("========================================");
        System.out.println();
